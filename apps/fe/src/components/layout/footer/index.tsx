            ...
            >
                <Col xs={24} sm={24} md={6} lg={6}>
                    ...
                    >
                        ...
                        quan, tốc độ tải trang nhanh, cùng kho phim với hơn 30.000+ phim mới, phim
                        hay, luôn cập nhật phim nhanh, hứa hẹn sẽ đem lại phút giây thư giãn cho
                        bạn.
                    </Text>
                </Col>
                ...
                <Col xs={12} sm={12} md={6} lg={6}>
                    ...
                    <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                        {regions?.slice(0, 6)?.map((region, index) => (
                            <li key={`${region.slug}_${index}`} style={{ marginBottom: '0.5rem' }}>
                                <Link
                                    className="link_item_blur"
                                    href={`${RouteNameEnum.MOVIE_LIST_PAGE}?${stringifyTableParams({
                                        filters: [
